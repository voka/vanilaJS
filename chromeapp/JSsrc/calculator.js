...
function evalMake(s){
	if(PreValue+str==""){
		if(s=="+"||s=="*"||s=="-"||s=="/"||s==".") {alert("처음엔 숫자를 입력하세요!");return;}
		else{
            if(s=="+"||s=="*"||s=="-"||s=="/"||s=="."){
                evalDo();
                str = str+s;
		...
		if(PreValue.charAt(PreValue.length-1)=="+"||PreValue.charAt(PreValue.length-1)=="*"||PreValue.charAt(PreValue.length-1)=="-"||PreValue.charAt(PreValue.length-1)=="/"||PreValue.charAt(PreValue.length-1)=="."){
            if(s=="+"||s=="*"||s=="-"||s=="/"||s=="."){
                evalDo();
                str = str+s;
            }
